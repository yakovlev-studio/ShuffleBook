...
import {scaleSize} from '../../animations/Scale';
...
export class Draggable extends Component {
  ...
  _panResponder = PanResponder.create({
    ...
    onPanResponderRelease: ({nativeEvent}, gestureState) => {
      ...
      this.x0 =
        nativeEvent.pageX -
        (widthOfFotoGalleryItem * scaleSize - widthOfFotoGalleryItem) / 2;
      ...
      if (isPhotoFallsInTargetArea(coordinates, this.props.shuffleBook)) {
        ...
        var cell = findCellDroppedPhotoLandedOn(
        ...
        this.props.setPhotoFrameDroppedPhotoLandedOnHandler(
          targetedFotoFrameIndex,
        );
