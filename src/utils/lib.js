...
import {viewportMiddlePoint} from '../components/FotoSpreadsSlider/FotoSpread/styles';
import {
  sortedIndex,
 ...
 * @returns {Array}
 */
const getDataForPhotoGalleryFlatList = (
  photos = [],
  numberOfFlatListItems = 10,
) => {
...
function isPhotoFallsInTargetArea(coordinates, state) {
  ...
  return isDroppedPhotoInFotoFramesContainer(
    coordinates,
    fotoFramesContainerCoordinates,
  );
}
...
function findFotoFrameMappedToTargetedCell(
  state = {},
  cell = [],
  coordinates = {},
) {
